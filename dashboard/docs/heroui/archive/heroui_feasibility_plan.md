> **ARCHIVE — Historical/pre-verification document.** This plan was written before external HeroUI documentation was accessed and before React 19 / Tailwind v4 upgrades were confirmed. The compatibility assessments here (React 18 risk, Tailwind 3 risk, "blocked" verdict) reflect the pre-verification state of the project. These assessments have since been superseded by `heroui_compatibility_audit.md`, `heroui_v3_0_3_research_report.md`, and `heroui_migration_plan.md`. Retained for historical rationale only — do not treat the risk levels or recommendations here as current.
