  ...
  return (
    <div className="mx-auto max-w-[420px] space-y-4 px-3 pb-6">
      <section className="rounded-lg border border-slate-200 bg-white p-4">
        ...
        <div className="mt-3 text-sm text-slate-600">Current state: {isIrrigating ? 'Running' : 'Stopped'}</div>
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-4">
        ...
        <div className="mt-3 grid gap-2">
          <label className="text-sm text-slate-700">Started at</label>
          <input className="rounded-md border border-slate-300 px-3 py-2 text-sm" type="datetime-local" value={backfillStartedAt} onChange={(e) => setBackfillStartedAt(e.target.value)} />
          <label className="text-sm text-slate-700">Ended at</label>
          <input className="rounded-md border border-slate-300 px-3 py-2 text-sm" type="datetime-local" value={backfillEndedAt} onChange={(e) => setBackfillEndedAt(e.target.value)} />
          <label className="text-sm text-slate-700">OR Duration minutes</label>
          <input className="rounded-md border border-slate-300 px-3 py-2 text-sm" type="number" min={1} placeholder="e.g. 45" value={backfillDurationMinutes} onChange={(e) => setBackfillDurationMinutes(e.target.value)} />
          <label className="text-sm text-slate-700">Target scope</label>
          <select className="rounded-md border border-slate-300 px-3 py-2 text-sm" value={backfillTargetScope} onChange={(e) => setBackfillTargetScope(e.target.value as typeof backfillTargetScope)}>
          ...
          <select className="rounded-md border border-slate-300 px-3 py-2 text-sm" value={backfillConfidence} onChange={(e) => setBackfillConfidence(e.target.value as 'exact' | 'estimated')}>
          ...
          <textarea className="rounded-md border border-slate-300 px-3 py-2 text-sm" value={backfillNotes} onChange={(e) => setBackfillNotes(e.target.value)} />
          <button className="mt-2 min-h-10 rounded-md bg-slate-900 text-white" onClick={async () => {
            setFormError(null);
