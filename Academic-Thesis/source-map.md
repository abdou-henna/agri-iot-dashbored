...
| Field Deployment | figures/field-*.png; IP65/CAT6 notes in figure-captions.md | Show deployed nodes; explain enclosure and cable selection |
| Limitations | limitations files | State supported scope |

## Field deployment figures (added 2026-05-15)

| File | Content |
|---|---|
| `figures/field-main-node-deployment.png` | MAIN node at Pivot 1 — IP65 enclosure, battery-powered |
| `figures/field-node2-soil-enclosure.png` | Node2 at Pivot 2 — CAT6 RJ45 cable to RS485 soil sensor |
| `figures/field-node3-weather-enclosure.png` | Node3 weather enclosure in field position |

**IP65 notes:** dust-total + water-jet protection; NOT submersion; electrical infrastructure nearby = field context only, NOT node power source.
**CAT6 notes:** outdoor insulation; humidity/soil resistance; multi-conductor RS485 utility; NOT Ethernet; node enclosure → soil sensor only.
**Rain/node_missing note:** temporal coincidence only; no experimental isolation; language must use "coincided with", "may have contributed", "requires further controlled validation".
